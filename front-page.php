...
<section class="fhc-hero" id="top">
    <div class="fhc-container fhc-hero-grid">
        ...
        <div class="fhc-card fhc-hero-card">
...
<section class="fhc-section fhc-section--alt" id="stats">
    <div class="fhc-container">
        <div class="fhc-section-header">
...
<section class="fhc-section fhc-section--alt" id="testimonials">
    <div class="fhc-container">
        <div class="fhc-section-header">
