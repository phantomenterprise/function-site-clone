...
{
    $wp_customize->add_section('fhc_header', [
        'title' => __('Header', 'function-health-clone'),
        'priority' => 20,
    ]);

    $wp_customize->add_setting('fhc_announcement_text', [
        'default' => 'Now available in all 50 states · Book your baseline labs today.',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('fhc_announcement_text', [
        'label' => __('Announcement bar text', 'function-health-clone'),
        'section' => 'fhc_header',
        'type' => 'text',
    ]);

    $wp_customize->add_setting('fhc_logo_text', [
        'default' => 'Function',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('fhc_logo_text', [
        'label' => __('Logo text', 'function-health-clone'),
        'section' => 'fhc_header',
        'type' => 'text',
    ]);

    $wp_customize->add_setting('fhc_header_links', [
        'default' => "How it works|#benefits\nLabs|#labs\nPricing|#pricing\nFAQ|#faq",
        'sanitize_callback' => 'sanitize_textarea_field',
    ]);
    $wp_customize->add_control('fhc_header_links', [
        'label' => __('Header links (Label|URL per line)', 'function-health-clone'),
        'section' => 'fhc_header',
        'type' => 'textarea',
    ]);

    $wp_customize->add_setting('fhc_header_button_text', [
        'default' => 'Join now',
        'sanitize_callback' => 'sanitize_text_field',
    ]);
    $wp_customize->add_control('fhc_header_button_text', [
        'label' => __('Header button text', 'function-health-clone'),
        'section' => 'fhc_header',
        'type' => 'text',
    ]);

    $wp_customize->add_setting('fhc_header_button_url', [
        'default' => '#pricing',
        'sanitize_callback' => 'esc_url_raw',
    ]);
    $wp_customize->add_control('fhc_header_button_url', [
        'label' => __('Header button URL', 'function-health-clone'),
        'section' => 'fhc_header',
        'type' => 'url',
    ]);
